...
Modeling polypharmacy side effects with graph convolutional networks by Marinka Zitnik et.al.: [Paper](https://academic.oup.com/bioinformatics/article/34/13/i457/5045770) ~ side effect prediction using GCN networks

Comprehensive Integration of Single-Cell Data by Tim Stuart et.al.: [Paper](https://www.cell.com/cell/pdf/S0092-8674(19)30559-8.pdf) ~ Seurat: mapping/anchoring in single cell data using MNN+CCA and scoring with SNN

scAlign: a tool for alignment, integration, and rare cell identification from scRNA-seq data by Nelson Johansen et.al.: [Paper](https://genomebiology.biomedcentral.com/articles/10.1186/s13059-019-1766-4) ~ bi-directional mapping with unsupervised deep learning. Outperform other mapping/integration methods such as Seurat, scVI, scanorama, MNN, scmap, MINT, scMerge.

On Usage of Autoencoders and Siamese Networks for Online Handwritten Signature Verification by Kian Ahrabian et.al.: [Paper](https://link.springer.com/article/10.1007/s00521-018-3844-z) ~ Comparing latent spaces of autoencoders using Siamese for offline signature verifications

Long non-coding RNA by 한남식: [paper](https://www.ibric.org/myboard/read.php?Board=report&id=2387)

Interpretable factor models of single-cell RNA-seq via variational autoencoders by Valentine Svensson et.al.: [Paper](https://academic.oup.com/bioinformatics/article/36/11/3418/5807606?login=true) ~ Linearly-decoded VAE implemented in scVI package

A benchmark of batch-effect correction methods for single-cell RNA sequencing data by Hoa Thi Nhu Tran et.al.: [Paper](https://genomebiology.biomedcentral.com/articles/10.1186/s13059-019-1850-9) ~ scRNAseq batch correction lists benchmark testings

scCobra: Contrastive cell embedding learning with domainadaptation for single-cell data integration by Bowen Zhao et.al.: [Paper](https://www.biorxiv.org/content/10.1101/2022.10.23.513389v1) ~ Batch correction effect with Bowen and Jun

<br>

## For Project on single cell deconvolution (2023 Spring ~ )

<*single-cell spatial modeling of cell identity in spot-resolution*>
             
SPICEMIX enables integrative single-cell spatial modeling of cell identity by Benjamin Chidester et.al.: [Paper](https://www.nature.com/articles/s41588-022-01256-z)

SpaGCN: Integrating gene expression, spatial location and histology to identify spatial domains and spatially variable genes by graph convolutional network by Jian Hu et.al.:[Paper](https://www.nature.com/articles/s41592-021-01255-8)

Spatial transcriptomics at subspot resolution with BayesSpace by Edward Zhao et.al.:[Paper](https://www.nature.com/articles/s41587-021-00935-2)

Identification of spatially associated subpopulations by combining scRNAseq and sequential fluorescence in situ hybridization data by Qian Zhu et.al.:[Paper](https://www.nature.com/articles/nbt.4260) ~ Hidden Markov random field.

Spatial reconstruction of single-cell gene expression data by Rahul Satija et.al.:[Paper](https://www.nature.com/articles/nbt.3192) ~ Seurat.

stLearn: integrating spatial location, tissue morphology and gene expression to find cell types, cell-cell interactions and spatial trajectories within undissociated tissues by Duy Pham et.al.:[Paper](https://www.biorxiv.org/content/10.1101/2020.05.31.125658v1.full.pdf)

<br>

<*Deconvolve spots into cells in spatial data*>

Single-cell and spatial transcriptomics enables probabilistic inference of cell type topography by Alma Andersson et.al.:[Paper](https://www.nature.com/articles/s42003-020-01247-y) ~ stereoscope

Robust decomposition of cell type mixtures in spatial transcriptomics by Dylan M. Cable et.al.:[Paper](https://www.nature.com/articles/s41587-021-00830-w) ~ RCTD

SPOTlight: seeded NMF regression to deconvolute spatial transcriptomics spots with single-cell transcriptomes by Marc Elousa-Bayes et.al:[Paper](https://academic.oup.com/nar/article/49/9/e50/6129341)

Spatially informed cell-type deconvolution for spatial transcriptomics by Ying Ma and Xiang Zhou:[Paper](https://doi.org/10.1038/s41587-022-01273-7) ~ CARD

Cell2location maps fine-grained cell types in spatial transcriptomics by Vitalii Kleshchevnikov et.al.:[Paper](https://doi.org/10.1038/s41587-021-01139-4)

SCDC: bulk gene expression deconvolution by multiple single-cell RNA sequencing references by Meichen Dong et.al.:[Paper](https://academic.oup.com/bib/article/22/1/416/5699815)

SpatialDWLS: accurate deconvolution of spatial transcriptomic data by Rui Dong and Guo-Cheng Yuan: [Paper](https://genomebiology.biomedcentral.com/articles/10.1186/s13059-021-02362-7)

Giotto: a toolbox for integrative analysis and visualization of spatial expression data by Ruben Dries et.al.:[Paper](https://genomebiology.biomedcentral.com/articles/10.1186/s13059-021-02286-2)

DSTG: deconvoluting spatial transcriptomics data through graph-based artificial intelligence by Qianqian Song and Jing Su:[Paper](https://doi.org/10.1093/bib/bbaa414)

Bulk tissue cell type deconvolution with multi-subject single-cell expression reference by Xuran Wang et.al.:[Paper](https://www.nature.com/articles/s41467-018-08023-x) ~ MuSiC

<br>

<*Summary of key problems in analysis and methods of spatial transcriptomics data*>
Deciphering tissue structure and function using spatial transcriptomics by Benjamin L. Walker et.al.:[Paper](https://doi.org/10.1038/s42003-022-03175-5)
...
Transposed convolution: [link1](https://towardsdatascience.com/what-is-transposed-convolutional-layer-40e5e6e31c11)
<br/>[link2](https://towardsdatascience.com/what-is-transposed-convolutional-layer-40e5e6e31c11)

VAE in pytorch: [link1](https://debuggercafe.com/getting-started-with-variational-autoencoder-using-pytorch/)
<br/>[link2](https://github.com/yunjey/pytorch-tutorial)
<br/>[link3](https://github.com/rasbt/stat453-deep-learning-ss21/tree/main/L09/code/custom-dataloader)
<br/>[link4](https://github.com/omniverse-labs/Deep-Learning-with-PyTorch/blob/main/variational_auto_encoders.ipynb)
<br/>[link5](https://avandekleut.github.io/vae/)
<br/>[link6](https://www.cs.toronto.edu/~lczhang/360/lec/w05/autoencoder.html)
<br/>[link7](https://pyro.ai/examples/vae.html)
<br/>[link8](https://www.jeremyjordan.me/autoencoders/)
<br/>[link9](https://www.jeremyjordan.me/variational-autoencoders/)
<br/>[link10](https://lilianweng.github.io/lil-log/2018/08/12/from-autoencoder-to-beta-vae.html) -> Loss, beta VAE, VQ VAE, TD VAE

Basic Linux: [Manual](https://www.pluralsight.com/guides/beginner-linux-navigation-manual)

BERT: [in Korean](https://wikidocs.net/115055)
