...
MetaboAnalyst 4.0: towards more transparent and integrative metabolomics analysis by Jasmine Chong et.al.: [Paper](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6030889/) ~ update 1. R-command tracking+display and companion metaboAnalystR package, 2. MS peaks to pathways to predict pathway activity from untargeted MS using mummichog, 3. biomarker meta-analysis thru combinationof multiple metabolomics data, and 4. network explorer for integrative analysis of metabolomics, metagenomics, transcriptomics
