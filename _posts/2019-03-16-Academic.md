...
Comprehensive Integration of Single-Cell Data by Tim Stuart et.al.: [Paper](https://www.cell.com/cell/pdf/S0092-8674(19)30559-8.pdf) ~ mapping/anchoring in single cell data using MNN+CCA and scoring with SNN

scAlign: a tool for alignment, integration, and rare cell identification from scRNA-seq data by Nelson Johansen et.al.: [Paper](https://genomebiology.biomedcentral.com/articles/10.1186/s13059-019-1766-4) ~ bi-directional mapping with unsupervised deep learning
